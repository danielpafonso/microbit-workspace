"""Micro:Bit Core functions stubs"""
# pylint: disable=C0103,R0913,E1120


def panic(value: int) -> None:
    """Enter a panic mode. Requires restart.

    value
      arbitrary integer, that is less or equal to 255, that indicate a status
    """
    _ = value
...
def sleep(milliseconds: int | float):
...
class accelerometer:
    ...
    @classmethod
    def is_gesture(cls, name: str) -> bool:
        """Return True or False to indicate if the named gesture is currently active
        
        name:
          gesture name to test
        """
        _ = name
        return False

    @classmethod
    def was_gesture(cls, name: str) -> bool:
...
class compass:
    ...
    @classmethod
    def clear_calibration(cls) -> None:
    ...
    @classmethod
    def get_field_strength(cls) -> int:
...
class display:
    """This module controls the 5x5 LED display on the front of your board. It can be used to
    ...
    def get_pixel(cls, x: int, y: int) -> int:
        ...
        x
          pixel column, values between 0 and 5
        y
          row row, values between 0 and 5
        """
        _x = x
        _y = y
        return 1
    ...
    @classmethod
    def set_pixel(cls, x: int, y: int, value: int) -> None:
        ...
        y
          row row, values between 0 and 5
        value
          brightness value, between 0 and 9
        """
        _x = x
        _y = y
        _v = value
    ...
    def show(
        cls,
        value: str | float | int | list | tuple,
        delay: int = 400,
        *,
        wait: bool = True,
        loop: bool = False,
        ...
        value 
          is a string, float or integer, display letters/digits in sequence. Otherwise,
        ...
        wait
          if True this function will block until the animation is finished, otherwise the
          animation will happen in the background.
        loop
          if True the animation will repeat forever.
        clear
          if True the display will be cleared after the iterable has finished.
    ...
    def scroll(
        ...
        *,
        ...
        value
          if an integer or float it is first converted to a string using str().
        delay
          controls how fast the text is scrolling.
        wait
          if True this function will block until the animation is finished, otherwise the
          animation will happen in the background.
        loop
          if True, the animation will repeat forever.
        monospace
          if True the characters will all take up 5 pixel-columns in width, otherwise
...
class _MicroBitDigitalPin:
    ...
    def write_digital(self, value: int) -> None:
        ...
        value
          1 will set the pin to High, 0 will set to Low
        """
        _ = value
...
class i2c:
    ...
    def init(
        cls,
        freq: int = 100000,
        sda:_MicroBitDigitalPin = pin20,
        scl: _MicroBitDigitalPin = pin19
    ) -> None:
    ...
    @classmethod
    def read(cls, addr:int, n: int, repeat: bool = False) -> bytes:
    ...
    @classmethod
    def write(cls, addr: int, buf: bytes, repeat: bool = False) -> None:
...
class Image:
    ...
    def __init__(self, *args, **kwargs):
        ...
        will create a 5x5 image of an X. The end of a line is indicated by a colon. It's also
    ...
    def shift_left(self, n: int) -> None:
    ...
    def blit(self, src, x, y, w, h, xdest=0, ydest=0) -> None:
...
class spi:
    ...
    @classmethod
    def read(cls, nbytes: int) -> bytes:
        """Read at most nbytes. Returns what was read"""
        _ = nbytes
        return b'\x00\x00'

    @classmethod
    def write(cls, buffer: bytes) -> None:
        """Write the buffer of bytes to the bus"""

    @classmethod
    def write_readinto(cls, out_buffer, in_buffer) -> None:
...
class uart:
    ...
    def init(
        ...
        stop: int = 1,
        *,
        tx: _MicroBitDigitalPin = None,
        rx: _MicroBitDigitalPin = None):
    ...
    @classmethod
    def read(cls, nbytes: int = None) -> bytes:
    ...
    @classmethod
    def readinto(cls, buffer: bytes, nbytes: int = None) -> bytes:
    ...
    @classmethod
    def write(cls, buf: str | bytes) -> int | None:
